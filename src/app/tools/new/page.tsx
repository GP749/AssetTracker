  ...
  return (
    <div className="mx-auto max-w-xl space-y-6">
      ...
      >
        ...
        {canUnsplash && (
          <label className="flex cursor-pointer items-start gap-2 rounded-md border border-white/5 bg-white/[0.02] p-3 text-sm">
            <input
              type="checkbox"
              name="fetchUnsplash"
              defaultChecked
            ...
            <span>
              <span className="font-medium text-zinc-100">
                Auto-fetch a photo from Unsplash
              </span>
              <span className="block text-xs text-zinc-500">
                Only used if no file is uploaded. Searches Unsplash for the
                tool name.
              </span>
            </span>
          </label>
